...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Assignment_1_Werrlein_Carmen", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Assignment_1_Werrlein_Carmen", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Assignment_1_Werrlein_Carmen";
		app.meta["name"] = "Assignment_1_Werrlein_Carmen";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "Assignment_1_Werrlein_Carmen",
			width: 640,
			x: null,
			y: null,
		};
